            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <small style="color: #64748b;"><i class="far fa-calendar-alt"></i> Diajukan: {{ $p->created_at?->format('d/m/Y') }}</small>
                    </td>
                    <td>
                        <strong style="color: #1e293b; display: block;">{{ $p->pic_nama }}</strong>
                    ...
                    <td>
                        ...
                        <div style="margin-top: 4px; display: flex; gap: 4px;">
                            @if($p->file_surat)
                                <a href="{{ route('admin.pengajuan.file', ['pengajuan' => $p->id, 'type' => 'surat']) }}" target="_blank" class="badge bg-light text-dark" title="Lihat Surat Permohonan"><i class="fas fa-file-pdf text-danger"></i> Surat</a>
                            @endif
                            @if($p->file_peserta)
                                <a href="{{ route('admin.pengajuan.file', ['pengajuan' => $p->id, 'type' => 'peserta']) }}" target="_blank" class="badge bg-light text-dark" title="Lihat Daftar Peserta"><i class="fas fa-file-excel text-success"></i> Excel</a>
                            @endif
                        </div>
                    </td>
                    <td>
